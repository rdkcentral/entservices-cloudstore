...
public:
    ...
    MOCK_METHOD(void*, Instantiate, (Thunder::RPC::Object&, const uint32_t, uint32_t&), (override));
    MOCK_METHOD(Thunder::RPC::IStringIterator*, GetLibrarySearchPaths, (const string&), (const, override));
