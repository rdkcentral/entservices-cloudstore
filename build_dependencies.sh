...
apt update
apt install -y libsqlite3-dev libcurl4-openssl-dev valgrind lcov clang libsystemd-dev libboost-all-dev meson curl protobuf-compiler-grpc libgrpc-dev libgrpc++-dev libunwind-dev libgstreamer1.0-dev libgstreamer-plugins-base1.0-dev
pip install jsonref
...
git clone --branch 1.0.1 https://$GITHUB_TOKEN@github.com/rdkcentral/entservices-testframework.git
